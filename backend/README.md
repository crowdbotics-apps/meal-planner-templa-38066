...
## Project Structure
    ...
    ├── meal_planner_templa_38066  # Django project configurations
...
1. Clone this repo and `cd meal_planner_templa_38066`
...
2. Clone this repo and `cd meal_planner_templa_38066`
